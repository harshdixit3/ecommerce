...
import { deliveries, payments } from "@/constants";
  ...
  const placeOrderHandler = () => {
    try {
      ...
      if (
        ...
        toast.error(
          "You order is not completed. Choose an address, a payment method and a delivery method to continue!"
        );
            ...
            <Formik
              ...
              onSubmit={async (values) => {
                ...
                if (addresses.length > 3) {
                  toast.success("You reached the address limit max:4");
                  setLoading(false);
                  return;
                }
